...
class AdminSettingToStudentPage extends StatefulWidget {
  final Function onSwitchParentType;       /// 切换上级状态
  AdminSettingToStudentPage({ @required this.onSwitchParentType });
  
  @override
  _AdminSettingToStudentPage createState() => _AdminSettingToStudentPage();
}

class _AdminSettingToStudentPage extends State<AdminSettingToStudentPage> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          AdminHeaderPage(title: "成为学员", onBack: () { widget.onSwitchParentType(100); }),
  ...
  void save() {
    ...
    HttpUtil.getInstance().postJson(API.toStudent, params: {
