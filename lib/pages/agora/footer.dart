...
class DongGanDanCheLiveFooter extends StatefulWidget {
  final Function onSendLiveMessage;
  const DongGanDanCheLiveFooter({
    Key key,
    this.onSendLiveMessage,
  }) : super(key: key);

  @override
  _DongGanDanCheLiveFooter createState() => _DongGanDanCheLiveFooter();
}

class _DongGanDanCheLiveFooter extends State<DongGanDanCheLiveFooter> {
      ...
      child: GestureDetector(
          child: Container(
            ...
            child: TextField (
              ...
              onSubmitted: (_) {
                // 发送消息
                widget.onSendLiveMessage(controllerMsg.text);
                controllerMsg.text = "";
              },
...
//      );
    ...
    return Container(
      ...
      child: Container(
        margin: EdgeInsets.only(bottom: BaseUtil.dp(10), left: BaseUtil.dp(10), right: BaseUtil.dp(10)),
...
//                                  color: Colors.white
  ...
  void sendLiveGift() {
    ...
    if (currentGiftTypeInfo.id > 0) {
      WebSocketUtil.sendMessage("giveLiveGift", {
